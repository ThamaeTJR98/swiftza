            ...
            {step === 'details' ? (
                <>
                    <div className="flex-1 overflow-y-auto no-scrollbar">
                        <div className={`p-4 space-y-4 pb-24 transition-all duration-300 ${[ErrandCategory.GROCERY_SHOPPING, ErrandCategory.PERSONAL_SHOPPING].includes(errandCategory) ? 'bg-slate-50' : 'bg-white'}`}>
                            
                            {/* Category Selector */}
                            <div className="flex gap-2 overflow-x-auto no-scrollbar pb-2">
                                {[
                                    { id: ErrandCategory.GROCERY_SHOPPING, label: 'Shopping Trip', icon: 'shopping_cart' },
                                    ...
                                    <div className="relative">
                                        <label className="text-[10px] text-blue-500 font-bold uppercase mb-1 block">
                                            {errandCategory === ErrandCategory.GOVT_QUEUE ? 'Queue Location' : 
                                             ...
                                             [ErrandCategory.GROCERY_SHOPPING, ErrandCategory.PERSONAL_SHOPPING].includes(errandCategory) ? 'Store (We take you there)' :
                                             'Store / Pickup'}
                                        </label>
                                        <div className="flex items-center gap-2 bg-gray-50 rounded-xl px-3 py-2 border border-transparent focus-within:border-blue-300 focus-within:bg-white transition-colors shadow-inner">
                                            <input 
                                                ...
                                                placeholder={errandCategory === ErrandCategory.GOVT_QUEUE ? "Where is the queue?" : 
                                                             ...
                                                             [ErrandCategory.GROCERY_SHOPPING, ErrandCategory.PERSONAL_SHOPPING].includes(errandCategory) ? 'Which store are you visiting?' :
                            ...
                            {/* --- ADAPTIVE SECTIONS --- */}
                            {[ErrandCategory.GROCERY_SHOPPING, ErrandCategory.PERSONAL_SHOPPING].includes(errandCategory) && (
                                <div className="animate-fade-in space-y-4">
                                    <div className="bg-blue-50 border border-blue-100 p-3 rounded-xl flex items-start gap-3">
                                        ...
                                        <p className="text-[10px] font-medium text-blue-700 leading-relaxed">
                                            <strong>Shopping Trip:</strong> Your runner will drive you to the store, wait for you to complete your shopping, and then drive you home. You are responsible for paying for your own goods at the store.
                                        </p>
                                    </div>
                                    <div className={`bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden flex flex-col transition-all duration-300 ${isItemsRetracted ? 'max-h-14' : 'max-h-[600px]'}`}>
                                        ...
                                        >
                                            <h3 className="text-xs font-black text-slate-800 uppercase tracking-wider flex items-center gap-2">
                                                <Icon name="list_alt" className="text-blue-500 text-base" />
                                                Shopping Notes
                                            </h3>
                                            <div className="flex items-center gap-2">
                                                <span className="text-[10px] font-bold text-blue-600 bg-blue-50 px-2 py-0.5 rounded-full">{errandItems.length} Notes</span>
                                        ...
                                        <div className="p-3 bg-white border-t border-slate-50">
                                            <div className="flex gap-2">
                                                <input 
                                                    ...
                                                    placeholder="Add note (e.g. Stop at Pharmacy too)" 
                                            ...
                                            {shoppingListImage && (
                                                <div className="mt-3 relative group">
                                                    <img src={shoppingListImage} alt="Shopping Notes" className="w-full h-32 object-cover rounded-xl border border-slate-200" />
                                                    <button 
                                    ...
                                    {![ErrandCategory.GROCERY_SHOPPING, ErrandCategory.PERSONAL_SHOPPING].includes(errandCategory) && (
                                        <div className="w-full bg-white border border-gray-200 rounded-xl px-3 flex flex-col justify-center shadow-sm py-2">
                                            <span className="text-[8px] font-bold text-slate-400 uppercase leading-none mb-0.5">Estimated Shopping Budget</span>
