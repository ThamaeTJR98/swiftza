...
export const CreatorWallet: React.FC = () => {
  ...
  const [punches, setPunches] = useState(() => {
      const saved = safeStorage.getItem('swiftza_loyalty_punches');
  ...
  const handleRedeemLoyalty = () => {
      ...
      setPunches(0);
      safeStorage.setItem('swiftza_loyalty_punches', '0');
  ...
  const handleAddDebugPunch = () => {
      if (punches < punchCardTotal) {
          ...
          safeStorage.setItem('swiftza_loyalty_punches', newPunches.toString());
      }
  };
