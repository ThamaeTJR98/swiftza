  ...
  const verifyPayment = async (reference: string) => {
    ...
    try {
        ...
        if (result.status) {
                    ...
                    ledger: [
                        {
                            ...
                            description: `Wallet Top Up (${result.channel || 'Paystack'})`,
                            amount: amountPaid,
            ...
            // Clean up URL before showing confirmation
            window.history.replaceState({}, document.title, window.location.pathname);

            // Show toast/banner instead of browser alert
            console.log(`✅ Payment of R${amountPaid} verified successfully!`);
        } else {
