...
export const Onboarding: React.FC<OnboardingProps> = ({ setView }) => {
  ...
  console.log("Onboarding view rendering. Step:", step);
  ...
  if (step === 'LANDING') {
    return (
      <div className="relative w-full min-h-[100dvh] bg-surface-white flex flex-col justify-between overflow-hidden font-display">
         ...
         <div className="relative z-10 flex flex-col h-full p-5 pt-safe-top pb-5 overflow-y-auto no-scrollbar">
            
            {/* Header Section */}
            <div className="flex flex-col items-center pt-6 text-center space-y-4 mt-auto mb-6">
                 ...
                 <div className="relative animate-float">
                    ...
                    <div className="relative bg-white text-white w-20 h-20 rounded-2xl flex items-center justify-center shadow-2xl shadow-brand-teal/40 transform -rotate-3 hover:rotate-0 transition-transform duration-500 ring-4 ring-white/30 overflow-hidden">
                        <img 
                            src="/icon-v3.png" 
                            alt="SwiftZA Logo" 
                            ...
                            onError={(e) => {
                                ...
                                console.log("Onboarding: Image error, parent found:", !!parent);
                                if (parent && parent.appendChild) {
                                    const icon = document.createElement('span');
                                    icon.className = 'material-icons-round text-4xl text-brand-teal';
                    ...
                    {/* SA Flag Dot */}
                    <div className="absolute -bottom-1 -right-1 w-7 h-7 bg-brand-gold border-4 border-white rounded-full flex items-center justify-center shadow-md">
                        <span className="text-[9px]">🇿🇦</span>
                    </div>
                 </div>
                 
                 <div>
                    <h1 className="text-3xl font-extrabold text-gray-900 mb-1 tracking-tight drop-shadow-sm">
                        Swift<span className="text-brand-teal">ZA</span>
                    </h1>
                    <p className="text-slate-600 text-xs max-w-[240px] mx-auto leading-relaxed font-semibold">
            ...
            {/* Action Buttons */}
            <div className="space-y-3 w-full mt-auto mb-4">
                <button 
                    onClick={() => setStep('CREATOR_INTRO')}
                    className="group w-full relative overflow-hidden bg-white/80 backdrop-blur-xl rounded-xl p-0.5 shadow-[0_10px_30px_-10px_rgba(0,0,0,0.1)] hover:shadow-[0_15px_40px_-12px_rgba(0,196,180,0.2)] transition-all duration-300 border border-white active:scale-[0.98] ring-1 ring-black/5"
                >
                    ...
                    <div className="flex items-center p-2.5">
                        <div className="flex-shrink-0 w-10 h-10 rounded-lg bg-brand-teal flex items-center justify-center text-white shadow-md group-hover:scale-110 transition-transform duration-300">
                            <span className="material-icons-round text-xl">add_task</span>
                        </div>
                        <div className="ml-3 text-left flex-1">
                            <h3 className="text-sm font-extrabold text-gray-900 group-hover:text-brand-teal transition-colors">I need a Service</h3>
                            <p className="text-[10px] text-slate-500 mt-0.5 font-medium leading-tight">Short Left, Errands, or Moves.</p>
                        </div>
                        <div className="text-gray-300 group-hover:text-brand-teal transition-colors bg-gray-50 rounded-full p-0.5">
                ...
                <button 
                    ...
                    className="group w-full relative overflow-hidden bg-white/80 backdrop-blur-xl rounded-xl p-0.5 shadow-[0_10px_30px_-10px_rgba(0,0,0,0.1)] hover:shadow-[0_15px_40px_-12px_rgba(253,184,19,0.3)] transition-all duration-300 border border-white active:scale-[0.98] ring-1 ring-black/5"
                >
                    ...
                    <div className="flex items-center p-2.5">
                        <div className="flex-shrink-0 w-10 h-10 rounded-lg bg-brand-gold flex items-center justify-center text-slate-900 shadow-md group-hover:scale-110 transition-transform duration-300">
                            <span className="material-icons-round text-xl">work</span>
                        </div>
                        <div className="ml-3 text-left flex-1">
                            <h3 className="text-sm font-extrabold text-gray-900 group-hover:text-yellow-600 transition-colors">I want to Earn</h3>
                            <p className="text-[10px] text-slate-500 mt-0.5 font-medium leading-tight">Drive or run errands for cash.</p>
                        </div>
                        <div className="text-gray-300 group-hover:text-yellow-500 transition-colors bg-gray-50 rounded-full p-0.5">
                            <span className="material-icons-round text-lg">chevron_right</span>
                        </div>
                    </div>
                </button>
            ...
            {/* Footer */}
            <div className="mt-2 flex flex-col items-center space-y-3 pb-safe">
                 <div className="flex items-center space-x-1 text-[10px] bg-white/60 backdrop-blur-sm px-3 py-1 rounded-full shadow-sm">
                ...
                <div className="flex items-center space-x-1 px-2.5 py-1 rounded-full bg-white/40 text-[9px] font-bold text-slate-400 border border-white/50 backdrop-blur-sm">
                    <span className="material-icons-round text-[10px]">public</span>
  ...
  if (step === 'CREATOR_INTRO') {
    return (
      <div className="w-full h-full min-h-[100dvh] bg-brand-teal flex flex-col font-display relative overflow-hidden">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6 relative z-10 text-white text-center min-h-0 py-2">
            <div className="absolute top-2 left-4 z-20">
                <button onClick={() => setStep('LANDING')} className="bg-white/20 p-1.5 rounded-full hover:bg-white/30 transition backdrop-blur-md">
            ...
            <div className="absolute top-1/4 left-4 opacity-10 transform -rotate-12 pointer-events-none">
                <span className="material-icons text-7xl">directions_run</span>
            </div>
            <div className="absolute top-1/3 right-6 opacity-10 transform rotate-12 pointer-events-none">
                <span className="material-icons text-6xl">local_shipping</span>
            </div>
            
            <div className="bg-white/10 rounded-full p-3 mb-3 backdrop-blur-sm border border-white/20 shadow-lg relative shrink-0">
                <div className="bg-white rounded-full p-2 shadow-inner flex items-center justify-center h-14 w-14 relative">
                     <span className="material-icons text-brand-teal text-2xl">add_task</span>
                </div>
            </div>
            
            <h1 className="text-xl font-bold mb-1 tracking-tight">One App, Many Solutions</h1>
            <p className="text-teal-50 text-[10px] leading-relaxed max-w-[240px] mb-4 px-2">
                Connect with verified runners & drivers in your area. Safe, simple, sharp.
            </p>
        </div>

        <div className="bg-gray-50 w-full rounded-t-[24px] p-5 pb-safe flex flex-col gap-3 relative z-10 shadow-[0_-10px_40px_rgba(0,0,0,0.2)] shrink-0">
            <div className="w-10 h-1 bg-gray-300 rounded-full mx-auto absolute top-2.5 left-1/2 transform -translate-x-1/2 opacity-50"></div>
            
            <div className="flex flex-col gap-2.5 mt-1">
                <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-lg bg-orange-100 text-orange-600 flex items-center justify-center shrink-0 shadow-sm">
                        <span className="material-symbols-rounded text-base">directions_run</span>
                    </div>
                    <div>
                        <h3 className="font-bold text-gray-900 text-xs">Shopping Trip</h3>
                        <p className="text-[9px] text-gray-500">We take you there to do your own groceries.</p>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h3 className="font-bold text-gray-900 text-xs">Package Delivery</h3>
                        <p className="text-[9px] text-gray-500">Send items across town and out of town.</p>
                    </div>
                </div>

                <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-lg bg-purple-100 text-purple-600 flex items-center justify-center shrink-0 shadow-sm">
                        <span className="material-symbols-rounded text-base">local_shipping</span>
                    </div>
                    <div>
                        <h3 className="font-bold text-gray-900 text-xs">Request Movers</h3>
                        <p className="text-[9px] text-gray-500">Book a bakkie and helpers for your move.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="space-y-2 pt-1">
                <button 
                    ...
                    className="w-full bg-brand-teal text-white font-semibold py-3 rounded-xl shadow-lg shadow-teal-500/30 active:scale-95 transition-transform flex items-center justify-center space-x-2 text-sm"
                >
  ...
  if (step === 'DRIVER_INTRO') {
    return (
      <div className="w-full h-full min-h-[100dvh] bg-slate-900 flex flex-col font-display relative overflow-hidden transition-colors duration-300">
        ...
        <div className="flex-1 flex flex-col items-center pt-safe-top px-6 pb-4 relative z-10 text-center overflow-y-auto no-scrollbar">
            <div className="mb-4 mt-6">
                <h1 className="text-xl font-bold text-white mb-1 tracking-tight">Make Money Mzansi</h1>
                <p className="text-slate-300 text-[10px] leading-relaxed max-w-[240px] mx-auto">
            ...
            <div className="mb-4 w-full flex justify-center space-x-2">
                 <button 
                    ...
                    className="bg-brand-gold text-slate-900 font-bold py-2.5 px-5 rounded-xl shadow-lg hover:bg-yellow-400 transition-transform transform active:scale-95 text-xs"
                >
                    Sign Up Now
                </button>
                <button 
                    onClick={handleLogin}
                    className="bg-transparent border-2 border-white/30 text-white font-bold py-2.5 px-5 rounded-xl hover:bg-white/10 transition-transform transform active:scale-95 text-xs"
                >
                    Log In
                </button>
            </div>

            <div className="w-full flex-1 bg-gray-50 rounded-t-2xl shadow-soft overflow-hidden flex flex-col relative animate-slide-up pb-safe min-h-[300px]">
                <div className="p-3 border-b border-gray-100 flex items-center justify-between bg-white sticky top-0 z-10">
                    <span className="material-icons-round text-gray-400 text-lg">filter_list</span>
                    <h2 className="font-bold text-gray-800 text-xs">Jobs Near You</h2>
